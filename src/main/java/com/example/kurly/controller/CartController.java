...
public class CartController {
    ...
    public ResponseEntity<?> insertCart(CartDTO cart) throws Exception {
            cartRepo.save(Cart.builder()
                    ...
                    .count(cart.getCount())
                    .build());
        return new ResponseEntity(DefaultResponse.res(StatusCode.OK, ResponseMessage.CART_INSERT), HttpStatus.OK);
    }
    ...
    @DeleteMapping
    public ResponseEntity<?> deleteCart(CartDTO cart) throws Exception {
        cartRepo.save(Cart.builder()
                .id(cart.getUserId())
                .pdNo(cart.getPdNo())
                .opNo(cart.getOpNo())
